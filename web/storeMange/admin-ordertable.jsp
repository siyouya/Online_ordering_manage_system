      ...
      <div class="am-u-sm-12">
        <form class="am-form" id="dish" >
          ...
          <table class="am-table am-table-striped am-table-hover table-main">
            <thead>
            <tr>
              <th class="table-check">订单编号</th>
              <th class="table-id">客户编号</th>
              <th class="table-title">商店编号</th>
              <th class="table-type">骑手编号</th>
              <th class="table-author">订单详情</th>
            ...
            <tr id="tr<%=order.getOid()%>">
              ...
              <td><%=order.getSid()%></td>
              <td><%=order.getRid()%></td>
              <td><%=order.getDlist()%></td>
              <td><%=order.getAcceptdate()%></td>
              <td><%=order.getCompletedate()%></td>
              <td><%=order.getState()%></td>
              <td>
                <div class="am-btn-toolbar">
                  <div class="am-btn-group am-btn-group-xs">
                    <button type="button" class="am-btn am-btn-default am-btn-xs am-text-secondary" onclick="for3('tr<%=order.getOid()%>')" data-toggle="modal"  data-target="#myModal2" ><span class="am-icon-pencil-square-o"></span> 编辑</button>
                    <button type="button" class="am-btn am-btn-default am-btn-xs"><a href="/dish?op=sellout&did=<%=order.getOid()%>"><span class="am-icon-copy" id="sellout"></span> 售罄</a></button>
                    <button type="button" class="am-btn am-btn-default am-btn-xs am-text-danger" onclick="deldish(<%=order.getOid()%>)"><span class="am-icon-trash-o"></span> 删除</button>
                  </div>
                </div>
              </td>
            </tr>
