        ...
        <form class="am-form" id="dish" method="post" action="/order">
          ...
          <table class="am-table am-table-striped am-table-hover table-main">
            ...
            <tr>
              ...
              <th class="table-title">骑手</th>
              <th class="table-text">订单详情</th>
            ...
            <tr id="tr<%=order.getOid()%>">
              ...
              <td>
                <div class="am-btn-toolbar">
                  <div class="am-btn-group am-btn-group-xs">
                    <button type="button" class="am-btn am-btn-default am-btn-xs am-text-danger" onclick="deldish(<%=order.getOid()%>)"><span class="am-icon-trash-o"></span> 取消</button>
                  </div>
                </div>
              </td>
            </tr>
