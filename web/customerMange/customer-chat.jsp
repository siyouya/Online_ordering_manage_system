...
<div class="am-cf admin-main">
  ...
  <script type="text/javascript" src="/customerMange/js/jquery.min.js"></script>
  <script type="text/javascript" src="/customerMange/js/chats.js"></script>
  <!-- content end -->
...
<script type="text/javascript">
 ...
 window.onload= function initWebSocket() {
    ...
    var username='<%=request.getAttribute("customername")%>';//有3个骑手顾客商家先测试1
